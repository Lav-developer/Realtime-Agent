...
function persistenceEnabled() {
  const flag = String(process.env.ENABLE_PERSISTENCE || '').toLowerCase();
...
function loadRooms() {
  if (!persistenceEnabled()) return { rooms: {}, meta: {} };
  try {
    ensureDir();
...
module.exports = { loadRooms, saveRooms, persistenceEnabled };
